...
import VoiceCarAssistant from "../../voice/components/VoiceCarAssistant";
import FakeYouTubeLayout from "../../voice/components/FakeYouTubeLayout";
import {
  useDmsCamera,
  useMediaPipe,
  useWebSocket,
...
export default function DriverMonitorDMS() {
  ...
  const {
    ...
    videoRef,
    status,
    smokingEnabled: SMOKING_ENABLED,
  });
