...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${getDmsApiBase()}${endpoint}`, {
        method: 'POST',
        headers: {
          ...
          <div className="bg-gradient-to-br from-blue-600 to-cyan-600 p-12 text-white flex flex-col justify-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-8">
                ...
                <h1 className="text-3xl font-bold">DMS - Driver Monitoring System</h1>
              </div>
              ...
              <p className="text-blue-100 text-lg mb-8">
                Hệ thống giám sát tài xế thông minh với công nghệ AI tiên tiến
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1">Nhận diện khuôn mặt</h3>
                    <p className="text-sm text-blue-100">Xác thực tài xế bằng Face ID AI</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  <div className="w-8 h-8 bg-white bg-opacity-20 rounded-lg flex items-center justify-center flex-shrink-0 mt-1">✓</div>
                  <div>
                    <h3 className="font-semibold mb-1">Giám sát hành vi lái xe</h3>
                    <p className="text-sm text-blue-100">Phát hiện buồn ngủ, điện thoại, thuốc lá</p>
                  </div>
                </div>
              </div>
            </div>
