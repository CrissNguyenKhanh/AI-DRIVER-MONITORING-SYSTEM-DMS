...
// import sukunaVideo from "./video/khanhvideo.mp4"; // Removed - video file deleted in Phase 1 cleanup
        ...
        <div className="bg-slate-800 rounded-xl overflow-hidden shadow-xl">
          {currentLabel === "sukuna" ? (
            <div className="relative aspect-video bg-black">
              {/* Video nền Sukuna - REMOVED: video file deleted in Phase 1 cleanup */}
              {/* <video
                src={sukunaVideo}
                autoPlay
                loop
