...
/**
 * SmokingFOMOOverlay - Overlay cảnh báo hút thuốc
 * @param {Object} props
 * @param {React.RefObject} props.smokingDetectionRef - Ref chứa trạng thái phát hiện hút thuốc
 * @param {React.RefObject} props.landmarksRef - Ref landmarks để tính mouth box
