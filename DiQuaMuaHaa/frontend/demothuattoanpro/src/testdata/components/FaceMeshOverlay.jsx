...
/**
 * FaceMeshOverlay - Vẽ mesh khuôn mặt, contour mắt, iris detection
 * @param {Object} props
 * @param {React.RefObject} props.landmarksRef - Ref chứa 468 facial landmarks
 * @param {React.RefObject} props.eyeDataRef - Ref dữ liệu mắt để tô màu blink
