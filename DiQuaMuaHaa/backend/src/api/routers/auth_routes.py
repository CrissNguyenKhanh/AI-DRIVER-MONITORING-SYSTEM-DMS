"""Authentication routes for driver identity verification.

Handles driver registration, face verification, Telegram binding,
and identity decision requests for non-owner driver scenarios.
"""
...
@app.get("/api/auth/driver_profile")
...
@app.post("/api/auth/telegram/bind")
...
@app.post("/api/auth/request_decision")
...
@app.get("/api/auth/decision_status")
