"""Driver monitoring routes for face, hand, smoking, and phone detection.

Provides RESTful endpoints for real-time driver behavior monitoring
using ML models for drowsiness detection, gesture recognition,
smoking detection, and phone usage detection.
"""
...
# ═══════════════════════════════════════════════════════════════
# FACE MONITORING API (drowsiness detection via face landmarks)
# ═══════════════════════════════════════════════════════════════

@app.post("/api/monitor/face/predict")
...
# ═══════════════════════════════════════════════════════════════
# SMOKING MONITORING API
# ═══════════════════════════════════════════════════════════════

@app.post("/api/monitor/smoking")
...
# ═══════════════════════════════════════════════════════════════
# PHONE MONITORING API
# ═══════════════════════════════════════════════════════════════

@app.post("/api/monitor/phone")
...
@app.post("/api/monitor/phone/detect")
...
# ═══════════════════════════════════════════════════════════════
# HAND GESTURE MONITORING API (for deaf/mute drivers)
# ═══════════════════════════════════════════════════════════════
...
@app.post("/api/monitor/hand/predict")
