"""
Smoking detection routes blueprint.
"""

from flask import Blueprint, jsonify, request

from src.services.prediction_service import predict_smoking
...
@smoking_bp.post("/api/smoking/predict_from_frame")
def smoking_predict_from_frame():
    """
    Detect smoking from face landmarks.
    ...
    try:
        ...
        result = predict_smoking(image_b64)
